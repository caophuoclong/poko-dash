...
export const STATUS_COLORS = {
  active: 'bg-accent-green-dim text-accent-green border border-accent-green-border',
  ...
  scheduled: 'bg-accent-orange-dim text-accent-orange border border-accent-orange-border',

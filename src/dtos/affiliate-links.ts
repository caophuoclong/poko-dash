...
export type CreateAffiliateLinkDto =
  components['schemas']['CreateAffiliateLinkDto']
export type UpdateAffiliateLinkDto =
  components['schemas']['UpdateAffiliateLinkDto']

export type PostAffiliateLinksRequest =
  operations['AffiliateLinksController_create']['requestBody']['content']['application/json']
export type PatchAffiliateLinksByLinkIdRequest =
  operations['AffiliateLinksController_patch']['requestBody']['content']['application/json']

...
export type RecordPublishSuccessDto =
  components['schemas']['RecordPublishSuccessDto']
export type RecordPublishFailureDto =
  components['schemas']['RecordPublishFailureDto']

export type PostContentPostsByPostIdPublicationsRequest =
  operations['PostPublicationsController_create']['requestBody']['content']['application/json']
export type PostContentPostsByPostIdPublicationsByPubIdSuccessRequest =
  operations['PostPublicationsController_recordSuccess']['requestBody']['content']['application/json']
export type PostContentPostsByPostIdPublicationsByPubIdFailureRequest =
  operations['PostPublicationsController_recordFailure']['requestBody']['content']['application/json']

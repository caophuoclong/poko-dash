...
export namespace WorkflowCredential {
  export type PostCredentialsRequest = import("./workflow-credential").PostCredentialsRequest;
  export type PostCredentialsResponse = import("./workflow-credential").PostCredentialsResponse;
}

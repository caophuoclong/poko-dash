...
export namespace Workflow {
  ...
  export type GetWorkflowsByIdResponse = import("./workflow").GetWorkflowsByIdResponse;
  export type PutWorkflowsByIdRequest = import("./workflow").PutWorkflowsByIdRequest;
  export type PutWorkflowsByIdResponse = import("./workflow").PutWorkflowsByIdResponse;
  export type PostWorkflowsByIdRunRequest = import("./workflow").PostWorkflowsByIdRunRequest;
  export type PostWorkflowsByIdRunResponse = import("./workflow").PostWorkflowsByIdRunResponse;
}

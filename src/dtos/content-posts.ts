...
export interface components {
    schemas: {
        CreateContentPostDto: {
             ...
             * @enum {string}
             */
            contentType: "review" | "comparison" | "roundup" | "tutorial" | "deal" | "trending";
...
export type GenerateContentPostsDto = components["schemas"]["GenerateContentPostsDto"];
export type UpdateContentPostStatusDto = components["schemas"]["UpdateContentPostStatusDto"];

export type PostContentPostsRequest = operations["ContentPostsController_create"]["requestBody"]["content"]["application/json"];
export type PostContentPostsBatchRequest = operations["ContentPostsController_batch"]["requestBody"]["content"]["application/json"];
export type PatchContentPostsByPostIdRequest = operations["ContentPostsController_patch"]["requestBody"]["content"]["application/json"];
export type PostContentPostsGenerateRequest = operations["ContentPostsController_generateFromProducts"]["requestBody"]["content"]["application/json"];
export type PatchContentPostsByPostIdStatusRequest = operations["ContentPostsController_updateStatus"]["requestBody"]["content"]["application/json"];

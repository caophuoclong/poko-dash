...
export interface components {
    schemas: {
        CreateContentIdeaDto: {
             ...
             * @enum {string}
             */
            ideaType: "review" | "comparison" | "roundup" | "tutorial" | "deal" | "trending";
            /**
...
export type ContentIdeaResponseDto = components["schemas"]["ContentIdeaResponseDto"];
...
export type PostContentIdeasRequest = operations["ContentIdeasController_create"]["requestBody"]["content"]["application/json"];
export type PostContentIdeasResponse = operations["ContentIdeasController_create"]["responses"][201]["content"]["application/json"];
export type GetContentIdeasByIdeaIdResponse = operations["ContentIdeasController_findById"]["responses"][200]["content"]["application/json"];
export type PatchContentIdeasByIdeaIdRequest = operations["ContentIdeasController_update"]["requestBody"]["content"]["application/json"];
export type PostContentIdeasGenerateRequest = operations["ContentIdeasController_generateIdeas"]["requestBody"]["content"]["application/json"];

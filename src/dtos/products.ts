...
export namespace Products {
  ...
  export type GetProductsErrorResponse =
    import('./products').GetProductsErrorResponse
  ...
  export type PostProductsErrorResponse =
    import('./products').PostProductsErrorResponse
  export type GetProductsByProductIdResponse =
    import('./products').GetProductsByProductIdResponse
  export type GetProductsByProductIdErrorResponse =
    import('./products').GetProductsByProductIdErrorResponse
  export type PatchProductsByProductIdRequest =
    import('./products').PatchProductsByProductIdRequest
  export type PatchProductsByProductIdResponse =
    import('./products').PatchProductsByProductIdResponse
  export type PatchProductsByProductIdErrorResponse =
    import('./products').PatchProductsByProductIdErrorResponse
  export type DeleteProductsByProductIdResponse =
    import('./products').DeleteProductsByProductIdResponse
  export type DeleteProductsByProductIdErrorResponse =
    import('./products').DeleteProductsByProductIdErrorResponse
}

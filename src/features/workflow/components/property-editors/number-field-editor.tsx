...
export function NumberFieldEditor({ schema, value, onChange }: PropertyEditorProps) {
  return (
    <div className="space-y-1">
      ...
      <input
        ...
        onChange={(e) => onChange(schema.key, e.target.value === '' ? undefined : Number(e.target.value))}
